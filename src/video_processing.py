...
#     # NEW
#     screen_folder = os.path.join(output_dir, "screens")  # Define a directory for screen captures
...
#             # NEW: Capture the screen at the same time as the webcam frame
#             current_timestamp = datetime.now().strftime("%Y%m%d_%H%M%S%f")
#             capture_screen(frame_count, current_timestamp, screen_folder)  # Capture screen
